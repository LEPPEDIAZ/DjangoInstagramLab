...
Instagram App por Ana lucia Diaz Leppe
        ...
        if self.username_field.unique:
            ...
            try:
                ...
                if brand=="3.1":
                    ...
                    self.stdout.write("3.4. Menu Principal")
                    self.stdout.write("-------------------------------")
                    segunda = input("Ingrese la funcion que desea obtener: ")
                    if segunda=="3.2":
                        self.stdout.write("----------------------")
                        ...
                        self.stdout.write("3.4. Menu Principal")
                        self.stdout.write("-------------------------------")
                        opcion = input("Ingrese la funcion que desea obtener: ")
                        if opcion=="3.3":
                            self.stdout.write("----------------------")
                            ...
                            if eliminar=="3.3.8":
                                Publish.objects.get(pk=8).delete()
                            if eliminar=="3.3.9":
                                Publish.objects.get(pk=9).delete()
                            if eliminar=="3.3.10":
                                Publish.objects.get(pk=10).delete()
                            if eliminar=="3.3.11":
                                Publish.objects.get(pk=11).delete()
                            if eliminar=="3.3.12":
                                Publish.objects.get(pk=12).delete()
                            if eliminar=="3.3.13":
                                Publish.objects.get(pk=13).delete()
                            if eliminar=="3.3.14":
                                Publish.objects.get(pk=14).delete()
                            if eliminar=="3.3.15":
                                Publish.objects.get(pk=15).delete()
                            if eliminar=="3.3.16":
                                Publish.objects.get(pk=16).delete()
                            for post in Publish.objects.all():
                                #print(post.id, post.nuevo)
                                print("post={0}:  {1} - {2}".format(post.id, post.nuevo, post.post))
                            self.stdout.write("BIENVENIDO!")
                            ...
                            self.stdout.write("3.4. Menu Principal")
                            self.stdout.write("-------------------------------")
                            menu = input("Ingrese la funcion que desea obtener: ")
                            if menu=="3.4":
                                self.stdout.write("----------------------")
                                self.stdout.write("MENU DE INSTAGRAM")
                                self.stdout.write("----------------------")
                ...
                if brand=="3.2":
                    ...
                    self.stdout.write("3.4. Menu Principal")
                    self.stdout.write("-------------------------------")
                    tercera = input("Ingrese la funcion que desea obtener: ")
                    if tercera=="3.3":
                        self.stdout.write("----------------------")
                        self.stdout.write("DELETE POST")
                        self.stdout.write("----------------------")
